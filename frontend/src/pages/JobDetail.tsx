                    ...
                    >
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                {job.company.logoUrl ? (
                                    <img src={getImageUrl(job.company.logoUrl)} alt="logo" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                ) : (
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                {job.company.bannerUrl && (
                    <div className="w-full h-48 sm:h-64 bg-gray-100 overflow-hidden border-b border-gray-200">
                        <img
                            src={getImageUrl(job.company.bannerUrl)}
                ...
                <div className={`p-8 border-b border-gray-100 bg-gray-50 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 ${job.company.bannerUrl ? 'relative' : ''}`}>
                    ...
                    <div className="flex-shrink-0 w-full md:w-auto flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                        <Link
                            to={`/company/${job.company.id}`}
                            className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-md border border-gray-300 bg-white text-gray-700 font-semibold text-sm hover:bg-gray-50 hover:border-gray-400 transition-colors shadow-sm"
                        >
